...
|-----------|------------|
| Global scope value | `GLOBAL_ALPHA` |
| Enclosing scope value | `ENCLOSING_OMEGA` |
| Local scope value | `LOCAL_PHI` |
| Counter initial value | `20` |
| Multiplier test input | `12` |
...
Global scope: GLOBAL_ALPHA
Enclosing scope: ENCLOSING_OMEGA
Local scope: LOCAL_PHI
```
